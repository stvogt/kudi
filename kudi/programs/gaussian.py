...
class _GetProperty:
    def __call__(self, func):
        def wrapper(*args, **kwargs):
            lines, search_tag, line_pos = func(*args, **kwargs)
            for line in lines:
...
class GaussianHarness:
    ...
    def get_energy(self):
        ...
        search_tag = "SCF Done"
        line_pos = 4
        return (self.lines, search_tag, line_pos)
    ...
    def get_occ_orbitals(self):
        ...
        return self.lines, occ_orb_pattern
